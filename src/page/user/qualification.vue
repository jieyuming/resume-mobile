<template>
  <div>
    <navbar title="职业资格信息" :rightStatus="true" @onDelete="onDelete"></navbar>
    <div class="list">
      ...
      <div class="space-between item">
        <div class="alpha fs-28">
          ...
          <span class="c-666">签发机构</span>
        </div>
        <div class="beta">
          <van-field
            class="input"
            v-model="userInfo.number1"
            name="name"
            center
            label
            placeholder="请输入"
...
export default {
  data() {
    return {
      countryIndex: 0,
      countryIndex1: 0,
      countryColumns: ["资格1", "资格12", "资格13"],
      countryColumns1: ["号码1", "号码13", "号码17"],
      userInfo: {
        country: "",
        country1: "",
        number: "",
